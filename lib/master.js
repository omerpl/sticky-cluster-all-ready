...
module.exports = function (workers, options) {
  ...
  function serverCreate() {
    ...
    return require('net').createServer({ pauseOnConnect: true }, function (connection) {
  ...
  function start() {
    ...
    serverStart(function () {
      ...
      workers.start(() => {
      // this callback called when all workers is up
      // master listens after all workers started
